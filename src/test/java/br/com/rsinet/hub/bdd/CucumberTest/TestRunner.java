...
@CucumberOptions(// Configurações do Cucumber
		...
		glue = "br.com.rsinet.hub.bdd.StepDefinition", // configuração do pacote que contém minhas step
		...
		monochrome = true,
		dryRun = false,
		tags = {"@Sucesso"} // Configurações das anotações que devem ser executadas
)
